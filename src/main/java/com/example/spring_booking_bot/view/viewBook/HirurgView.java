...
@Component
public class HirurgView implements WorkerCommand {
    @Override
    public SendMessage start(Update update) {
        if (!update.getMessage().getText().equals("Запись к хирургу")){
            return null;
        }
    ...
    public SendMessage sendDefaultMessage(Update update) {
        ...
        DeleteHelper.getDeleteHelper().setDoctorEnum(DoctorEnum.HIRURG);
        List<String> listTime = ViewHelper.getDoctorTime(DoctorEnum.HIRURG);
