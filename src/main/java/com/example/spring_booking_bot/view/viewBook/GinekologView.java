...
@Component
public class GinekologView implements WorkerCommand {
    @Override
    public SendMessage start(Update update) {
        if (!update.getMessage().getText().equals("Запись к гинекологу")){
            return null;
        }
    ...
    public SendMessage sendDefaultMessage(Update update) {
        ...
        DeleteHelper.getDeleteHelper().setDoctorEnum(DoctorEnum.GINEKOLOG);
        List<String> listTime = ViewHelper.getDoctorTime(DoctorEnum.GINEKOLOG);
